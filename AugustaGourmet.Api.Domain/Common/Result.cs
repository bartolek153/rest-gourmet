...
namespace AugustaGourmet.Api.Domain.Common.Result
{
    /// <summary>
    ...
    public class Result
    {
        ...
        protected Result(bool isSuccess, ErrorTemporary error)
        {
            if (isSuccess && error != ErrorTemporary.None)
            {
        ...
        public static Result<TValue> Success<TValue>(TValue value) => new Result<TValue>(value, true, ErrorTemporary.None);
        ...
        public static Result<TValue> Create<TValue>(TValue value, ErrorTemporary error)
            where TValue : class
        ...
        public static Result Failure(ErrorTemporary error) => new Result(false, error);
        ...
        /// </remarks>
        public static Result<TValue> Failure<TValue>(ErrorTemporary error) => new Result<TValue>(default!, false, error);
